package com.habiaral.app.Panitikan.Pabula.Stories;
...
import com.habiaral.app.Panitikan.Pabula.Quiz.PabulaKwento1Quiz;
...
public class PabulaKwento1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.panitikan_pabula_kwento1);
        ...
        unlockButton.setOnClickListener(v -> {
            ...
            if (isLessonDone) {
                ...
                startActivity(new Intent(PabulaKwento1.this, PabulaKwento1Quiz.class));
            }
        });
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    boolean isFirst = prefs.getBoolean("isFirstOpenPabula1", true);

                    if (isFirst && !isLessonDone) {
                        loadIntroLines();
                        prefs.edit().putBoolean("isFirstOpenPabula1", false).apply();
                    }
                }
            } else {
    ...
    private void loadIntroLines() {
        ...
        db.collection("lesson_character_lines").document("LCL21").get()
        ...
        if (currentPage > 0) {
            ...
            if (currentPage == 0) {
                if (!isLessonDone) {
                    ...
                    introPlayed = false;
                    loadIntroLines();
                    prefs.edit().putBoolean("isFirstOpenPabula1", true).apply();
                } else {
                    introFinished = true;
                    introPlayed = true;
                }
