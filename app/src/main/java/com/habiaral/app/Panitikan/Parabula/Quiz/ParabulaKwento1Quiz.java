...
public class ParabulaKwento1Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "ParabulaKwento1", STORY_TITLE = "Alibughang Anak";
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("ParabulaKwento1");
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(ParabulaKwento2.class);
        });
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(ParabulaKwento1Quiz.this, lessonActivityClass);
    ...
    private void saveQuizResultToFirestore() {
        ...
        db.collection("module_progress").document(uid).update(updates)
                .addOnSuccessListener(unused -> {
                    Toast.makeText(this, "Nabuksan na ang kwento: Nawawalang Tupa!", Toast.LENGTH_SHORT).show();
