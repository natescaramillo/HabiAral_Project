...
public class EpikoKwento2Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "EpikoKwento2", STORY_TITLE = "Epiko ni Gilgamesh";
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("EpikoKwento2");
