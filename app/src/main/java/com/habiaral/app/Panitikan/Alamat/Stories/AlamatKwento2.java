package com.habiaral.app.Panitikan.Alamat.Stories;
...
import com.habiaral.app.Panitikan.Alamat.Quiz.AlamatKwento2Quiz;
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    boolean isFirst = prefs.getBoolean("isFirstOpenAlamat2", true);

                    if (isFirst && !isLessonDone) {
                        loadIntroLines();
                        prefs.edit().putBoolean("isFirstOpenAlamat2", false).apply();
                    }
                }
            } else {
        ...
        if (currentPage > 0) {
            ...
            if (currentPage == 0) {
                if (!isLessonDone) {
                    ...
                    introPlayed = false;
                    loadIntroLines();
                    prefs.edit().putBoolean("isFirstOpenAlamat2", true).apply();
                } else {
                    introFinished = true;
                    introPlayed = true;
                }
