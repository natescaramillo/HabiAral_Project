package com.habiaral.app.Panitikan.Parabula.Stories;
...
import com.habiaral.app.Panitikan.Parabula.Quiz.ParabulaKwento1Quiz;
...
public class ParabulaKwento1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.panitikan_parabula_kwento1);
        ...
        unlockButton.setOnClickListener(v -> {
            ...
            if (isLessonDone) {
                ...
                startActivity(new Intent(ParabulaKwento1.this, ParabulaKwento1Quiz.class));
            }
        });
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    boolean isFirst = prefs.getBoolean("isFirstOpenParabula1", true);

                    if (isFirst && !isLessonDone) {
                        loadIntroLines();
                        prefs.edit().putBoolean("isFirstOpenParabula1", false).apply();
                    }
                }
            } else {
    ...
    private void loadIntroLines() {
        ...
        db.collection("lesson_character_lines").document("LCL23").get()
        ...
        if (currentPage > 0) {
            ...
            if (currentPage == 0) {
                if (!isLessonDone) {
                    ...
                    introPlayed = false;
                    loadIntroLines();
                    prefs.edit().putBoolean("isFirstOpenParabula1", true).apply();
                } else {
                    introFinished = true;
                    introPlayed = true;
                }
