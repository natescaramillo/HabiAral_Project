package com.habiaral.app.Panitikan.MaiklingKuwento.Quiz;
...
import com.habiaral.app.Panitikan.MaiklingKuwento.Stories.MaiklingKuwento2;
...
public class MaiklingKuwento1Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "MaiklingKuwento1", STORY_TITLE = "Suyuan sa Tubigan";
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storyCategory = (Map<String, Object>) categories.get("Maikling Kuwento");
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("MaiklingKuwento1");
