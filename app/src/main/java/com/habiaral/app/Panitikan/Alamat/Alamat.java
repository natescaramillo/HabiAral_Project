package com.habiaral.app.Panitikan.Alamat;
...
import com.habiaral.app.Panitikan.Alamat.Stories.AlamatKwento1;
import com.habiaral.app.Panitikan.Alamat.Stories.AlamatKwento2;
...
public class Alamat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.panitikan_alamat);
    ...
    private boolean isFirstTime() {
        return getSharedPreferences("AlamatPrefs", MODE_PRIVATE)
                .getBoolean("isFirstTime", true);
    }

    private void setFirstTimeShown() {
        getSharedPreferences("AlamatPrefs", MODE_PRIVATE)
                .edit()
    ...
    private void updateUIFromProgress(Map<String, Object> data) {
        ...
        Map<String, Object> alamatCat = (Map<String, Object>) categories.get("Alamat");
        if (alamatCat == null) return;

        Map<String, Object> stories = (Map<String, Object>) alamatCat.get("stories");
        if (stories == null) return;

        boolean kwento1Done = isCompleted(stories, "AlamatKwento1");
        boolean kwento2Done = isCompleted(stories, "AlamatKwento2");
