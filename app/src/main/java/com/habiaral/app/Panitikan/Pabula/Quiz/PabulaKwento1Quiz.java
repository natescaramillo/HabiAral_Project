package com.habiaral.app.Panitikan.Pabula.Quiz;
...
import com.habiaral.app.Panitikan.Pabula.Pabula;
import com.habiaral.app.Panitikan.Pabula.Stories.PabulaKwento2;
...
public class PabulaKwento1Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "PabulaKwento1", STORY_TITLE = "Ang Kalapati at Ang Agila";
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q21")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("PabulaKwento1");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PabulaKwento1Quiz.this)) {
                resultPlayer = MediaPlayer.create(PabulaKwento1Quiz.this, soundRes);
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(PabulaKwento2.class);
        });

        homeButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(Pabula.class);
        });
    }
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(PabulaKwento1Quiz.this, lessonActivityClass);
    ...
    private void saveQuizResultToFirestore() {
        ...
        updates.put("module_3.categories.Pabula.stories." + STORY_ID + ".title", STORY_TITLE);
        updates.put("module_3.categories.Pabula.stories." + STORY_ID + ".status", "completed");
    ...
    private void checkIfCategoryCompleted(String categoryName) {
        db.collection("module_progress").document(uid).get()
                .addOnSuccessListener(snapshot -> {
                    ...
                    String[] requiredStories = {"PabulaKwento1", "PabulaKwento2"};
