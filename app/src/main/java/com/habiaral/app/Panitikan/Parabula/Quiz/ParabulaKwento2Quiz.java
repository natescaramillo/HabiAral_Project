package com.habiaral.app.Panitikan.Parabula.Quiz;
...
import com.habiaral.app.Panitikan.Parabula.Parabula;
...
public class ParabulaKwento2Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "ParabulaKwento2", STORY_TITLE = "Nawawalang Tupa";
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storyCategory = (Map<String, Object>) categories.get("Parabula");
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("ParabulaKwento2");
