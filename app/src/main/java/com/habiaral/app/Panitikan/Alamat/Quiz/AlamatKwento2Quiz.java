package com.habiaral.app.Panitikan.Alamat.Quiz;
...
import com.habiaral.app.Panitikan.Alamat.Alamat;
...
public class AlamatKwento2Quiz extends AppCompatActivity {
    ...
    private static final String STORY_ID = "AlamatKwento2", STORY_TITLE = "Ang Alamat ng Unggoy";
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q16")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> storiesStory = (Map<String, Object>) stories.get("AlamatKwento2");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(AlamatKwento2Quiz.this)) {
                resultPlayer = MediaPlayer.create(AlamatKwento2Quiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(AlamatKwento2Quiz.this, lessonActivityClass);
