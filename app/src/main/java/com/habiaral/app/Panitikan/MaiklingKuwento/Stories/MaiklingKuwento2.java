package com.habiaral.app.Panitikan.MaiklingKuwento.Stories;
...
import com.habiaral.app.Panitikan.MaiklingKuwento.Quiz.MaiklingKuwento2Quiz;
...
public class MaiklingKuwento2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.panitikan_maikling_kwento_kwento2);
        ...
        btnBack.setOnClickListener(v -> {
            ...
            v.postDelayed(() -> {
                startActivity(new Intent(MaiklingKuwento2.this, MaiklingKuwento.class)
        ...
        unlockButton.setOnClickListener(v -> {
            ...
            if (isLessonDone) {
                ...
                startActivity(new Intent(MaiklingKuwento2.this, MaiklingKuwento2Quiz.class));
            }
        });
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    boolean isFirst = prefs.getBoolean("isFirstOpenMaiklingKuwento2", true);

                    if (isFirst && !isLessonDone) {
                        loadIntroLines();
                        prefs.edit().putBoolean("isFirstOpenMaiklingKuwento2", false).apply();
                    }
                }
            } else {
    ...
    private void loadIntroLines() {
        ...
        db.collection("lesson_character_lines").document("LCL20").get()
        ...
        if (currentPage > 0) {
            ...
            if (currentPage == 0) {
                if (!isLessonDone) {
                    ...
                    introPlayed = false;
                    loadIntroLines();
                    prefs.edit().putBoolean("isFirstOpenMaiklingKuwento2", true).apply();
                } else {
                    introFinished = true;
                    introPlayed = true;
                }
