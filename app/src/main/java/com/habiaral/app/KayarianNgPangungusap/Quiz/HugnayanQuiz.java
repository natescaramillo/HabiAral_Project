...
import com.habiaral.app.KayarianNgPangungusap.Lessons.LangkapanLesson;
...
public class HugnayanQuiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q13")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("hugnayan");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(HugnayanQuiz.this)) {
                resultPlayer = MediaPlayer.create(HugnayanQuiz.this, soundRes);
    ...
    private void saveQuizResultToFirestore() {
        ...
        lessonsMap.put("hugnayan", status);
