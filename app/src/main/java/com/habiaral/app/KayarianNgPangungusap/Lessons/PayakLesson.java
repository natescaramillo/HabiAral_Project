...
import com.habiaral.app.KayarianNgPangungusap.Quiz.PayakQuiz;
    ...
    private void startIdleGifRandomizer() {
        ...
        idleGifRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Math.random() < 0.4) {
                    if (!isFinishing() && !isDestroyed()) {
                        Glide.with(PayakLesson.this).asGif().load(R.drawable.right_2).into(imageView2);
                    }
                    idleGifHandler.postDelayed(() -> {
                        if (isActivityActive && imageView2 != null && !isFinishing() && !isDestroyed()) {
                            Glide.with(PayakLesson.this).asGif().load(R.drawable.idle).into(imageView2);
                        }
                        ...
                        if (module2 != null) {
                            ...
                            if (lessons != null) {
                                ...
                                if (payak != null) {
                                    ...
                                    String introStatus = (String) payak.get("intro");
