...
import com.habiaral.app.Panitikan.Panitikan;
...
public class LangkapanQuiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q14")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("langkapan");
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(Panitikan.class);
        });
