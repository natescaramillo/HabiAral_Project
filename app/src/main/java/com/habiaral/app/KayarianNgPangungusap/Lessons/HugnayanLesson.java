package com.habiaral.app.KayarianNgPangungusap.Lessons;
...
import com.habiaral.app.KayarianNgPangungusap.Quiz.HugnayanQuiz;
...
public class HugnayanLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionImageView.setImageResource(R.drawable.hugnayan1);
        exampleImageView.setImageResource(R.drawable.hugnayan2);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.kayarian_lesson), (v, insets) -> {
    ...
    private void startIdleGifRandomizer() {
        ...
        idleGifRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Math.random() < 0.4) {
                    if (!isFinishing() && !isDestroyed()) {
                        Glide.with(HugnayanLesson.this).asGif().load(R.drawable.right_2).into(imageView2);
                    }
                    idleGifHandler.postDelayed(() -> {
                        if (isActivityActive && imageView2 != null && !isFinishing() && !isDestroyed()) {
                            Glide.with(HugnayanLesson.this).asGif().load(R.drawable.idle).into(imageView2);
                        }
                        ...
                        if (module2 != null) {
                            ...
                            if (lessons != null) {
                                ...
                                if (hugnayan != null) {
                                    ...
                                    String introStatus = (String) hugnayan.get("intro");
    ...
    private void loadCharacterLines() {
        db.collection("lesson_character_lines").document("LCL13")
                .get()
