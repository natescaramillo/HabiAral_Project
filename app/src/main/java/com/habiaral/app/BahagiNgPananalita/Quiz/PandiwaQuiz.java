...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangUriLesson;
...
public class PandiwaQuiz extends AppCompatActivity {
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("pandiwa");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PandiwaQuiz.this)) {
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(PangUriLesson.class);
        });
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Bukas na ang Susunod na Aralin: Pang-Uri!", Toast.LENGTH_SHORT).show();
    }
