...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangUkolLesson;
...
public class PangatnigQuiz extends AppCompatActivity {
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("pangatnig");
    ...
    private void saveQuizResultToFirestore() {
        ...
        lessonsMap.put("pangatnig", status);
