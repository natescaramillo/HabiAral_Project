...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangHalipLesson;
...
public class PangUriQuiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q3")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("panguri");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PangUriQuiz.this)) {
                resultPlayer = MediaPlayer.create(PangUriQuiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(PangUriQuiz.this, lessonActivityClass);
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Bukas na ang Susunod na Aralin: Pang-Halip!", Toast.LENGTH_SHORT).show();
    }
