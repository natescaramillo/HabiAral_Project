package com.habiaral.app.BahagiNgPananalita.Quiz;
...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangAbayLesson;
...
public class PangHalipQuiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q4")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("panghalip");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PangHalipQuiz.this)) {
                resultPlayer = MediaPlayer.create(PangHalipQuiz.this, soundRes);
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(PangAbayLesson.class);
        });
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(PangHalipQuiz.this, lessonActivityClass);
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Bukas na ang Susunod na Aralin: Pang-Abay!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void saveQuizResultToFirestore() {
        ...
        lessonsMap.put("panghalip", status);
