...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangAngkopLesson;
...
public class PangUkolQuiz extends AppCompatActivity {
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("pangukol");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PangUkolQuiz.this)) {
    ...
    private void saveQuizResultToFirestore() {
        ...
        lessonsMap.put("pangukol", status);
