...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangawingLesson;
...
public class PandamdamQuiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q9")
                .get()
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("pandamdam");
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(PandamdamQuiz.this, lessonActivityClass);
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Bukas na ang Susunod na Aralin: Pangawing!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void saveQuizResultToFirestore() {
        ...
        lessonsMap.put("pandamdam", status);
