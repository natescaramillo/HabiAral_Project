...
import com.habiaral.app.BahagiNgPananalita.Quiz.PangAbayQuiz;
...
public class PangAbayLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            ...
            startActivity(new Intent(PangAbayLesson.this, BahagiNgPananalita.class)
        ...
        unlockButton.setOnClickListener(v -> {
            ...
            stopTTS();
            startActivity(new Intent(this, PangAbayQuiz.class));
        });
    ...
    private void updatePage() {
        ...
        BahagiFirestoreUtils.saveLessonProgress(BahagiFirestoreUtils.getCurrentUser().getUid(),
                "pangabay", currentPage, isLessonDone);
    ...
    private void checkLessonStatus() {
        ...
        FirebaseFirestore.getInstance().collection("module_progress").document(user.getUid()).get()
                .addOnSuccessListener(snapshot -> {
                    if (snapshot.exists()) {
                        ...
                        if (module1 != null) {
                            ...
                            if (lessons != null && lessons.containsKey("pangabay")) {
                                Map<String, Object> lessonList = (Map<String, Object>) lessons.get("pangabay");
                                if (lessonList != null) {
                    ...
                    BahagiFirestoreUtils.saveLessonProgress(user.getUid(), "pangabay", currentPage, isLessonDone);
                });
    }

    private void loadCharacterLines() {
        FirebaseFirestore.getInstance().collection("lesson_character_lines").document("LCL5").get()
            ...
            @Override public void onDone(String utteranceId) {
                runOnUiThread(() -> {
                    ...
                    if (index[0] < lines.size()) {
                        if (!SoundManagerUtils.isMuted(PangAbayLesson.this)) {
