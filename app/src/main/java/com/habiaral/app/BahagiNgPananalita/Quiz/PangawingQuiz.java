...
import com.habiaral.app.Utils.AchievementDialogUtils;
...
public class PangawingQuiz extends AppCompatActivity {
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> lessonss = (Map<String, Object>) lessons.get("pangawing");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(PangawingQuiz.this)) {
                resultPlayer = MediaPlayer.create(PangawingQuiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        stopTimerSound();
        releaseResultPlayer();
        Intent intent = new Intent(PangawingQuiz.this, lessonActivityClass);
