...
import com.habiaral.app.BahagiNgPananalita.Lessons.PangatnigLesson;
...
public class PangAbayQuiz extends AppCompatActivity {
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Bukas na ang Susunod na Aralin: Pangatnig!", Toast.LENGTH_SHORT).show();
    }
