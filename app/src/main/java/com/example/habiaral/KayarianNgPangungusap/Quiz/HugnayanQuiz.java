...
public class HugnayanQuiz extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = findViewById(R.id.hugnayanNextButton);
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(com.example.habiaral.KayarianNgPangungusap.Quiz.HugnayanQuiz.this, LangkapanLesson.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(com.example.habiaral.KayarianNgPangungusap.Quiz.HugnayanQuiz.this, KayarianNgPangungusap.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
    ...
    private void saveQuizResultToFirestore() {
        ...
        hugnayanStatus.put("status", "completed");

        Map<String, Object> lessonsMap = new HashMap<>();
        lessonsMap.put("hugnayan", hugnayanStatus);
