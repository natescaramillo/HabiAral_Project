...
public class TambalanLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionImageView = findViewById(R.id.description_image_tambalan);
        exampleImageView = findViewById(R.id.example_image_tambalan);
    ...
    private void initTextToSpeech() {
        ...
        introCompleted = prefs.getBoolean("tambalan_quiz_unlocked", false);
                            ...
                            speakLinesSequentially(descriptionLines, () -> {
                                ...
                                speakLinesSequentially(exampleLines, () -> {
                                    runOnUiThread(() -> {
                                        ...
                                        introCompleted = true;
                                        SharedPreferences prefs = getSharedPreferences("lesson_prefs", MODE_PRIVATE);
                                        prefs.edit().putBoolean("tambalan_quiz_unlocked", true).apply();
                                    });
                                });
                            });
                        });
