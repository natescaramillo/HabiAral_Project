...
//            stopTTS();
            startActivity(new Intent(this, TambalanQuiz.class));
        });
...
//                "tambalan", currentPage, isLessonDone);
//
//        stopSpeaking();
                    ...
                    if (snapshot.exists()) {
                        ...
                        if (module1 != null) {
                            ...
                            if (lessons != null && lessons.containsKey("tambalan")) {
                                ...
                                if (tambalan != null) {
                                    Long checkpoint = (Long) tambalan.get("checkpoint");
                                    currentPage = (checkpoint != null) ? checkpoint.intValue() : 0;
                                    isFirstTime = false;
                                    if ("completed".equals(tambalan.get("status"))) {
                                        isLessonDone = true;
                                        unlockButton.setEnabled(true);
                                        unlockButton.setAlpha(1f);
                                    }
...
//                        imageView.setImageResource(pangngalanLesson[currentPage]);
                    ...
                    KayarianFirestoreUtils.saveLessonProgress(user.getUid(), "tambalan", currentPage, isLessonDone);
                });
    }
...
//                        if (!SoundManager.isMuted(TambalanLesson.this)) {
