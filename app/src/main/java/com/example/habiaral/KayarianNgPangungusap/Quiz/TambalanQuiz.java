...
public class TambalanQuiz extends AppCompatActivity{
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(com.example.habiaral.KayarianNgPangungusap.Quiz.TambalanQuiz.this, HugnayanLesson.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(com.example.habiaral.KayarianNgPangungusap.Quiz.TambalanQuiz.this, KayarianNgPangungusap.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
