...
public class ParabulaKwento3Quiz extends AppCompatActivity {
    Button nextButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.panitikan_kwento3_quiz);
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(ParabulaKwento3Quiz.this, ParabulaKwento4.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(ParabulaKwento3Quiz.this, Parabula.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
