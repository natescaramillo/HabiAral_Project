...
import com.example.habiaral.Panitikan.Pabula.Quiz.PabulaKwento4Quiz;
...
public class PabulaKwento4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(PabulaKwento4.this, PabulaKwento4Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(PabulaKwento4.this, Pabula.class)
