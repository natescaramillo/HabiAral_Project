...
public class EpikoKwento2Quiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q18")
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(EpikoKwento2Quiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> epikoCategory = (Map<String, Object>) categories.get("Epiko");
        if (epikoCategory == null) return false;

        Map<String, Object> stories = (Map<String, Object>) epikoCategory.get("stories");
        if (stories == null) return false;

        Map<String, Object> epiko1Story = (Map<String, Object>) stories.get("EpikoKwento2");
        return epiko1Story != null && "completed".equals(epiko1Story.get("status"));
    }
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(EpikoKwento2Quiz.this)) {
                resultPlayer = MediaPlayer.create(EpikoKwento2Quiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        ...
        Intent intent = new Intent(EpikoKwento2Quiz.this, lessonActivityClass);
