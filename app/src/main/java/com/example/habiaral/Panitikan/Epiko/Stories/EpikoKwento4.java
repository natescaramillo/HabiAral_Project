...
import com.example.habiaral.Panitikan.Epiko.Quiz.EpikoKwento4Quiz;
...
public class EpikoKwento4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(EpikoKwento4.this, EpikoKwento4Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(EpikoKwento4.this, Epiko.class)
