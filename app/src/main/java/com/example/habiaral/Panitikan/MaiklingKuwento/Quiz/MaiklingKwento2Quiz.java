...
public class MaiklingKwento2Quiz extends AppCompatActivity {
    Button nextButton;
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(MaiklingKwento2Quiz.this, MaiklingKwento3.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(MaiklingKwento2Quiz.this, MaiklingKuwento.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
