...
import com.example.habiaral.Panitikan.MaiklingKuwento.Quiz.MaiklingKwento3Quiz;
...
public class MaiklingKwento3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(MaiklingKwento3.this, MaiklingKwento3Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(MaiklingKwento3.this, MaiklingKuwento.class)
