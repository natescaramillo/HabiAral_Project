...
public class MaiklingKuwento2Quiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q20")
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(MaiklingKuwento2Quiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> maiklingkuwento1Story = (Map<String, Object>) stories.get("MaiklingKuwento2");
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(MaiklingKuwento2Quiz.this)) {
                resultPlayer = MediaPlayer.create(MaiklingKuwento2Quiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        ...
        Intent intent = new Intent(MaiklingKuwento2Quiz.this, lessonActivityClass);
