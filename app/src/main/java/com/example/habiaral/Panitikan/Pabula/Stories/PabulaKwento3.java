...
import com.example.habiaral.Panitikan.Pabula.Quiz.PabulaKwento3Quiz;
...
public class PabulaKwento3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(PabulaKwento3.this, PabulaKwento3Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(PabulaKwento3.this, Pabula.class)
