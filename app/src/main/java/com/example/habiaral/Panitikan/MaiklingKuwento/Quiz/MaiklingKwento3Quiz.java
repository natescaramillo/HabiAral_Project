...
public class MaiklingKwento3Quiz extends AppCompatActivity {
    Button nextButton;
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(MaiklingKwento3Quiz.this, MaiklingKwento4.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(MaiklingKwento3Quiz.this, MaiklingKuwento.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
