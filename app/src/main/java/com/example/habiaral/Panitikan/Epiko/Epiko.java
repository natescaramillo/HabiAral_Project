...
import com.example.habiaral.Panitikan.Epiko.Stories.EpikoKwento3;
import com.example.habiaral.Panitikan.Epiko.Stories.EpikoKwento4;
...
public class Epiko extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        btnKwento1.setOnClickListener(v -> {
            ...
            startActivity(new Intent(this, EpikoKwento1.class));
        });
        ...
        btnKwento3.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            startActivity(new Intent(this, EpikoKwento3.class));
        });

        btnKwento4.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            startActivity(new Intent(this, EpikoKwento4.class));
        });
    }
