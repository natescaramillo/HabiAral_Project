package com.example.habiaral.Panitikan.Parabula;
...
import com.example.habiaral.Panitikan.Parabula.Stories.ParabulaKwento3;
import com.example.habiaral.Panitikan.Parabula.Stories.ParabulaKwento4;
...
public class Parabula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pag_unawa_parabula);
    ...
    private void initViews() {
        ...
        btnKwento1.setOnClickListener(v -> {
            ...
            startActivity(new Intent(this, ParabulaKwento1.class));
        });

        btnKwento2.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            startActivity(new Intent(this, ParabulaKwento2.class));
        });

        btnKwento3.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            startActivity(new Intent(this, ParabulaKwento3.class));
        });

        btnKwento4.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            startActivity(new Intent(this, ParabulaKwento4.class));
        });
    }
    ...
    private void checkAndCompleteModule(boolean kwento1Done, boolean kwento2Done, boolean kwento3Done, boolean kwento4Done) {
        ...
        module3Updates.put("modulename", "Parabula");
