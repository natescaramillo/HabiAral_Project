...
public class EpikoKwento3Quiz extends AppCompatActivity {
    Button nextButton;
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(EpikoKwento3Quiz.this, EpikoKwento4.class);
        ...
        homeButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(EpikoKwento3Quiz.this, Epiko.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
