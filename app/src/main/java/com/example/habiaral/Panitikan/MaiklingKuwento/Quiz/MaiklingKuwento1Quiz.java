...
public class MaiklingKuwento1Quiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q19")
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(MaiklingKuwento1Quiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> maiklingkuwentoCategory = (Map<String, Object>) categories.get("Maikling Kuwento");
        if (maiklingkuwentoCategory == null) return false;

        Map<String, Object> stories = (Map<String, Object>) maiklingkuwentoCategory.get("stories");
        if (stories == null) return false;

        Map<String, Object> maiklingkuwento1Story = (Map<String, Object>) stories.get("MaiklingKuwento1");
        return maiklingkuwento1Story != null && "completed".equals(maiklingkuwento1Story.get("status"));
    }
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(MaiklingKuwento1Quiz.this)) {
                resultPlayer = MediaPlayer.create(MaiklingKuwento1Quiz.this, soundRes);
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(MaiklingKuwento2.class);
        });

        homeButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(MaiklingKuwento.class);
        });
    }
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        ...
        Intent intent = new Intent(MaiklingKuwento1Quiz.this, lessonActivityClass);
    ...
    private void checkIfCategoryCompleted(String categoryName) {
        db.collection("module_progress").document(uid).get()
                .addOnSuccessListener(snapshot -> {
                    ...
                    String[] requiredStories = {"MaiklingKuwento1", "MaiklingKuwento2"};
