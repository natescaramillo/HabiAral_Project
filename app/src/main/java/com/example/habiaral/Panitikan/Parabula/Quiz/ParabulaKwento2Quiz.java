...
public class ParabulaKwento2Quiz extends AppCompatActivity {
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q24")
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(ParabulaKwento2Quiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> parabulaCategory = (Map<String, Object>) categories.get("Parabula");
        if (parabulaCategory == null) return false;

        Map<String, Object> stories = (Map<String, Object>) parabulaCategory.get("stories");
        if (stories == null) return false;

        Map<String, Object> parabula1Story = (Map<String, Object>) stories.get("ParabulaKwento2");
        return parabula1Story != null && "completed".equals(parabula1Story.get("status"));
    }
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            if (MuteButtonUtils.isSoundEnabled(ParabulaKwento2Quiz.this)) {
                resultPlayer = MediaPlayer.create(ParabulaKwento2Quiz.this, soundRes);
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(Parabula.class);
        });
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        ...
        Intent intent = new Intent(ParabulaKwento2Quiz.this, lessonActivityClass);
