...
import com.example.habiaral.Panitikan.MaiklingKuwento.Quiz.MaiklingKwento2Quiz;
...
public class MaiklingKwento2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(MaiklingKwento2.this, MaiklingKwento2Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(MaiklingKwento2.this, MaiklingKuwento.class)
