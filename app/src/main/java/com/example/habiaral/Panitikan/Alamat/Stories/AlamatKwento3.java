...
import com.example.habiaral.Panitikan.Alamat.Quiz.AlamatKwento3Quiz;
...
public class AlamatKwento3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(AlamatKwento3.this, AlamatKwento3Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(AlamatKwento3.this, Alamat.class)
    ...
    private void saveProgressToFirestore() {
        ...
        progressMap.put("modulename", "Alamat");
