...
public class PabulaKwento1Quiz extends AppCompatActivity {
    ...
    private static final String STORY_TITLE = "Ang Kalapati at Agila";
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(PabulaKwento1Quiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> pabula1Story = (Map<String, Object>) stories.get("PabulaKwento1");
