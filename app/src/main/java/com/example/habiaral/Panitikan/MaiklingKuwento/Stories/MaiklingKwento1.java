...
import com.example.habiaral.Panitikan.MaiklingKuwento.Quiz.MaiklingKwento1Quiz;
...
public class MaiklingKwento1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(MaiklingKwento1.this, MaiklingKwento1Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(MaiklingKwento1.this, MaiklingKuwento.class)
