...
import com.example.habiaral.Panitikan.Parabula.Quiz.ParabulaKwento3Quiz;
...
public class ParabulaKwento3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.panitikan_kwento3);
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(ParabulaKwento3.this, ParabulaKwento3Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(ParabulaKwento3.this, Panitikan.class)
    ...
    private void saveProgressToFirestore() {
        ...
        progressMap.put("modulename", "Parabula");
