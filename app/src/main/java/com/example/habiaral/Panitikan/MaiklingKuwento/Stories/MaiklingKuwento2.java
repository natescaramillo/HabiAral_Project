...
public class MaiklingKuwento2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            ...
            startActivity(new Intent(MaiklingKuwento2.this, BahagiNgPananalita.class)
        ...
        textToSpeech = new TextToSpeech(this, status -> {
            if (status == TextToSpeech.SUCCESS) {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    boolean isFirst = prefs.getBoolean("isFirstOpenMaikling2", true);

                    if (isFirst) {
                        loadIntroLines();
                        prefs.edit().putBoolean("isFirstOpenMaikling2", false).apply();
                    }
                }
            } else {
    ...
    private void previousPage() {
        ...
        if (currentPage > 0) {
            ...
            if (currentPage == 0) {
                ...
                introPlayed = false;
                loadIntroLines();
                prefs.edit().putBoolean("isFirstOpenMaikling2", true).apply();
