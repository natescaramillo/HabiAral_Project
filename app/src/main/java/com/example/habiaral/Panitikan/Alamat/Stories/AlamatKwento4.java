...
import com.example.habiaral.Panitikan.Alamat.Quiz.AlamatKwento4Quiz;
...
public class AlamatKwento4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(AlamatKwento4.this, AlamatKwento4Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(AlamatKwento4.this, Alamat.class)
