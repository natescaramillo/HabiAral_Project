...
import com.example.habiaral.Panitikan.Parabula.Quiz.ParabulaKwento4Quiz;
...
public class ParabulaKwento4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(v -> {
            if (isLessonDone) {
                Intent intent = new Intent(ParabulaKwento4.this, ParabulaKwento4Quiz.class);
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            @Override public void handleOnBackPressed() {
                startActivity(new Intent(ParabulaKwento4.this, Panitikan.class)
