...
public class PangAbayQuiz extends AppCompatActivity {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (percent <= 25 && lastColorStage == 1) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangAbayQuiz.this, R.drawable.timer_color_red)
                    );
                    playTimerSound(R.raw.red_timer);
                    lastColorStage = 0;
                } else if (percent <= 50 && lastColorStage == 2) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangAbayQuiz.this, R.drawable.timer_color_orange)
                    );
                    playTimerSound(R.raw.orange_timer);
                    lastColorStage--;
                } else if (percent > 50 && lastColorStage == 3) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangAbayQuiz.this, R.drawable.timer_color_green)
                    );
    ...
    private void showResultDialog() {
        ...
        taposButton.setOnClickListener(v -> {
            SoundClickUtils.playClickSound(this, R.raw.button_click);
            dismissAndReleaseResultDialog();
            navigateToLesson(PangatnigLesson.class);
        });
    ...
    private void saveQuizResultToFirestore() {
        ...
        if (LessonProgressCache.getData() != null) {
            ...
            cachedModule1.put("current_lesson", "pangabay");
