...
public class PangUkolQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText = findViewById(R.id.pangukol_questionText);
    ...
    private void loadQuizDocument() {
        db.collection("quiz").document("Q7")
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (percent <= 25 && lastColorStage == 1) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUkolQuiz.this, R.drawable.timer_color_red)
                    );
                    playTimerSound(R.raw.red_timer);
                    lastColorStage = 0;
                } else if (percent <= 50 && lastColorStage == 2) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUkolQuiz.this, R.drawable.timer_color_orange)
                    );
                    playTimerSound(R.raw.orange_timer);
                    lastColorStage--;
                } else if (percent > 50 && lastColorStage == 3) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUkolQuiz.this, R.drawable.timer_color_green)
                    );
    ...
    private void showResultDialog() {
        ...
        resultDialog.setOnShowListener(d -> {
            ...
            resultPlayer = MediaPlayer.create(PangUkolQuiz.this, soundRes);
    ...
    private void navigateToLesson(Class<?> lessonActivityClass) {
        ...
        Intent intent = new Intent(PangUkolQuiz.this, lessonActivityClass);
