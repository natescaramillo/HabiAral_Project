...
public class PangUriQuiz extends AppCompatActivity {
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 100) {
            ...
            private void playLoopingSound(int soundId) {
                if (!MuteButtonUtils.isSoundEnabled(PangUriQuiz.this)) return;
    ...
    private boolean hasPassedQuizBefore() {
        ...
        Map<String, Object> panguriLesson = (Map<String, Object>) lessons.get("panguri");
        return panguriLesson != null && "completed".equals(panguriLesson.get("status"));
    }
