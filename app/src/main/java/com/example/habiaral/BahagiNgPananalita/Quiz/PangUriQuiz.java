...
public class PangUriQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText = findViewById(R.id.panguri_questionText);
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (percent <= 25 && lastColorStage == 1) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUriQuiz.this, R.drawable.timer_color_red)
                    );
                    playTimerSound(R.raw.red_timer);
                    lastColorStage = 0;
                } else if (percent <= 50 && lastColorStage == 2) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUriQuiz.this, R.drawable.timer_color_orange)
                    );
                    playTimerSound(R.raw.orange_timer);
                    lastColorStage--;
                } else if (percent > 50 && lastColorStage == 3) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangUriQuiz.this, R.drawable.timer_color_green)
                    );
    ...
    private void unlockNextLesson() {
        Toast.makeText(this, "Next Lesson Unlocked: Pang-halip!", Toast.LENGTH_SHORT).show();
    }
