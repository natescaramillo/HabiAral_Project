...
public class PangHalipQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bahagi_ng_pananalita_panghalip_quiz);

        questionTitle = findViewById(R.id.questionTitle);
        questionText = findViewById(R.id.panghalip_questionText);
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (percent <= 25 && lastColorStage == 1) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangHalipQuiz.this, R.drawable.timer_color_red)
                    );
                    playTimerSound(R.raw.red_timer);
                    lastColorStage = 0;
                } else if (percent <= 50 && lastColorStage == 2) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangHalipQuiz.this, R.drawable.timer_color_orange)
                    );
                    playTimerSound(R.raw.orange_timer);
                    lastColorStage--;
                } else if (percent > 50 && lastColorStage == 3) {
                    timerBar.setProgressDrawable(
                            ContextCompat.getDrawable(PangHalipQuiz.this, R.drawable.timer_color_green)
                    );
