...
public class PangawingLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(PangawingLesson.this, BahagiNgPananalita.class);
    ...
    private void saveProgressToFirestore(boolean completed) {
        ...
        pangawingStatus.put("status", statusToSave);
        pangawingStatus.put("checkpoint", currentPage);
    ...
    private void loadCharacterLines() {
        ...
        db.collection("lesson_character_lines").document("LCL10")
                .get()
