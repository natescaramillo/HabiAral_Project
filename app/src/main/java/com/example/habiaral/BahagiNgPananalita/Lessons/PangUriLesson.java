...
public class PangUriLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(view -> {
            ...
            startActivity(new Intent(PangUriLesson.this, PangUriQuiz.class));
        });
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(PangUriLesson.this, BahagiNgPananalita.class);
    ...
    private void saveProgressToFirestore(boolean completed) {
        ...
        panguriStatus.put("status", statusToSave);
        panguriStatus.put("checkpoint", currentPage);
        ...
        moduleMap.put("current_lesson", "panguri");
    ...
    private void loadCharacterLines() {
        ...
        db.collection("lesson_character_lines").document("LCL3")
                .get()
