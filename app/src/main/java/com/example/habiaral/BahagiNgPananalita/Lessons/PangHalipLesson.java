...
public class PangHalipLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockButton.setOnClickListener(view -> {
            ...
            startActivity(new Intent(PangHalipLesson.this, PangHalipQuiz.class));
        });
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(PangHalipLesson.this, BahagiNgPananalita.class);
    ...
    private void saveProgressToFirestore(boolean completed) {
        ...
        panghalipStatus.put("status", statusToSave);
        panghalipStatus.put("checkpoint", currentPage);
    ...
    private void loadCharacterLines() {
        ...
        db.collection("lesson_character_lines").document("LCL4")
                .get()
