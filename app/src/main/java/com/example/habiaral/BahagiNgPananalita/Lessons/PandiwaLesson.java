...
public class PandiwaLesson extends AppCompatActivity {
    ...
    private final int[] pandiwaLesson = {
            R.drawable.pandiwa01, R.drawable.pandiwa02, R.drawable.pandiwa03,
            R.drawable.pandiwa04, R.drawable.pandiwa05, R.drawable.pandiwa06,
            R.drawable.pandiwa07, R.drawable.pandiwa08, R.drawable.pandiwa09,
            R.drawable.pandiwa10, R.drawable.pandiwa11, R.drawable.pandiwa12,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.imageViewPandiwa);
    ...
    private void nextPage() {
        if (currentPage < pandiwaLesson.length - 1) {
            currentPage++;
                    ...
                    if (snapshot.exists()) {
                        ...
                        if (module1 != null) {
                            ...
                            if (lessons != null && lessons.containsKey("pandiwa")) {
                                ...
                                if (pandiwa != null) {
                                    Long checkpoint = (Long) pandiwa.get("checkpoint");
                                    currentPage = (checkpoint != null) ? checkpoint.intValue() : 0;
                                    isFirstTime = false;

                                    if ("completed".equals(pandiwa.get("status"))) {
                                        isLessonDone = true;
                                        unlockButton.setEnabled(true);
                                        unlockButton.setAlpha(1f);
                                    }
    ...
    private void saveProgressToFirestore(boolean completed) {
        ...
        pandiwaStatus.put("status", statusToSave);
        pandiwaStatus.put("checkpoint", currentPage);
    ...
    private void loadCharacterLines() {
        ...
        db.collection("lesson_character_lines").document("LCL2")
                .get()
